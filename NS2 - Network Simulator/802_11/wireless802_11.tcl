...
set val(initialenergy_11)  1000           ;# Initial energy in Joules = 1000
...
set nm wireless802_11.nam
set tr wireless802_11.tr
set topo_file topo_wireless802_11.txt
#set topo_file 5.txt
#
# Initialize ns
#
...
set tx [lindex $argv 4]
set tx_range [expr 150*$tx]
#set tx_range 250
...
for {set i 0} {$i < [expr $num_row*$num_col]} {incr i} {
  ...
  #set energy($i) [expr rand()*$tx_range]
  set energy($i) $tx_range
...
#    set null_($i) [new Agent/Null]
	...
	#using modification congestion constant_cwnd_size_
  #$udp_($i) set windowOption_ 10
  #$udp_($i) set constant_cwnd_size_ 20
}
